        ...
        <form>
            ...
            <nav class="col-md-4 col-md-offset-4">
                <ul class="pagination">
                    ...
                    echo "<li class='active'><a href='./work.php?page={$page}'>{$page}<span class='sr-only'>(current)</span></a></li>";
                    for($i = $page+1; $i<$page+5 && $i-1<$countPage;$i++)
                        echo "<li><a href='./work.php?page={$i}'>{$i}</a></li>";
                    if($page>= $countPage)
                        echo "<li><a href='#' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a></li>";
                    else
                        echo "<li><a href='./work.php?page={$nextPage}' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a></li>";
                    ?>
                </ul>
            </nav>
        </form>
